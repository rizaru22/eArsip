...
if($_GET['action'] == "table_data"){
   $query = mysqli_query($mysqli, "SELECT * FROM disposisi WHERE pengirim='$_SESSION[idpegawai]' ORDER BY tanggal DESC, iddisposisi DESC") or die ("Error :".mysqli_error($mysqli));
   $data = array();
   $no = 1;
