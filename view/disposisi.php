...
<script type="text/javascript" src="script/disposisi.js"></script>
<?php
session_start();
...
//judul
create_title("transfer","Disposisi Surat Masuk");
//button
...
open_form ("dataSuratMasuk","return save_data()");
create_table(array("No Surat", "Tanggal Surat", "Perihal", "Sumber","File","Aksi"));
close_form2();
